...
<?php
	...
	$qry = $conn->query("SELECT * FROM position ");
...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<div class="row form-group">
			<div class="col-md-4">
				<label for="" class="control-label">Interview</label>
		...
		<div class="row form-group">
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="csalary" required="" value="<?php echo isset($csalary) ? $csalary:''  ?>">
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Expected Salary</label>
			 <input type="text" class="form-control" name="esalary" required="" value="<?php echo isset($esalary) ? $esalary:''  ?>">
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Experience</label>
			 <input type="text" class="form-control" name="experience" required="" value="<?php echo isset($experience) ? $experience:''  ?>">
			</div>
			
		 
			<div class=" col-md-4">
				 <label for="" class="control-label">Notice Period </label>
				<select name="dojoining" class="control-label" required="" value="<?php echo isset($dojoining) ? $dojoining:''  ?>">
