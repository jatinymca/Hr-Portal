...
<div class="row">
	<div class="col-md-12">
		<div class="row form-group">
			<div class="col-md-6">
				<label for="" class="control-label">Round</label>
		...
		<div class="row form-group">
			<div class="col-md-6 "  id="nextinterview" style="display:none;">
				<label for="" class="control-label">Next Round</label>
				<select class="custom-select browser-default select2" name="nextview">
					<option value="" > --Select-- </option>
				  	<?php
				  			$rs = $conn->query("SELECT * FROM recruitment_status ");
			...
			<div class="col-md-6" id="nextitimming" style="display:none;">
				<label for="" class="control-label">Next Round Timming</label>
				 <input type="datetime-local" class="form-control" name="nextinterview"   >
			</div>
		</div>
	<!-- 	<div class="row form-group ">
			<div class="col-md-6"  id="nextinterview" style="display:none;">
