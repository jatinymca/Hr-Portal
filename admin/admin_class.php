...
Class Action {
	...
	function save_application(){
       ...
       ;
       				echo "SELECT  `email`, `contact`  FROM `application` where  email='$email' AND contact='$contact'";
						  
		$select = $this->db->query("SELECT  `email`, `contact`  FROM `application` where  email='$email' AND contact='$contact'");
